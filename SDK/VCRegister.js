...
VCRegister.prototype.register = function(host, account, password){
  var self = this;
  self.alias = account;
  self.host = host;
...
VCRegister.prototype.unregister = function(callback){
  var self = this;
...
VCRegister.prototype.requestToken = function(host, alias, username, password, callback){
...
VCRegister.prototype.refreshToken = function(callback){
  var self = this;
  var xhr = prepareRequest(
      'post', [
...
VCRegister.prototype.releaseToken = function(callback){
  var self = this;
  if(self.token)
  {
    var xhr = prepareRequest(
...
VCRegister.prototype.reject = function(alias, token){
  var self = this;
